...
rem arm-none-eabi-gcc -mcpu=cortex-a7 -fpic -ffreestanding -std=gnu99 -c src/kernel.c -o target/kernel.o -O2 -Wall -Wextra
rem arm-none-eabi-gcc -T linker.ld -o target/EmiOS.elf -ffreestanding -O2 -nostdlib target/boot.o target/kernel.o
